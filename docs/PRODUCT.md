...
- Service worker (`sw.js`, `CACHE_NAME` `alchemy-v17`). Trigger: page load. Cache-first for the app shell and Google Fonts. Invalidation is manual, by version bump.
